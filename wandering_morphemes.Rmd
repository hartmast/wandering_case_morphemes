...
To get a glimpse of the distribution of adpositions in present-day language, as well as changes in the relative frequencies of adpositions over time, we plot the number of prepositions, posipositions and circumpositions in the "public" archive of [DWDS](https://www.dwds.de/), containing from the German Text Archive (DTA) and from corpora of contemporary German.
